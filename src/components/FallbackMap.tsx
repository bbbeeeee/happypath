...
type FallbackLens = "route" | "shade" | "cover" | "amenities";
...
export function FallbackMap({ graph, route, lens, shadeSegments, coverSegments, ambientCover, selection, assets, prominentAssetIds, selectedAssetId, onAssetClick }: {
  graph: PilotGraph;
