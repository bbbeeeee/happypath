...
await writeFile(REGISTRY_OUTPUT, `${JSON.stringify({ sources: [{
  ...
  derived_from: [],
  method_version: "osm-pedestrian-graph-v2",
  known_limitations: ["Mapped access and crossing completeness varies", "Snapshot is not proof of legal completeness or step-free access", "Turn restrictions are not yet modeled", "Edge geometry preserves mapped OSM shape nodes but does not establish sidewalk-side topology"],
