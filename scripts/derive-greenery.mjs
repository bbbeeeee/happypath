...
other.push({ ...common, source_id: "greenery-edge-model", publisher: "Footnote", dataset_name: "Pilot tree and park adjacency", dataset_url: "https://data.cityofnewyork.us/d/hn5i-inap", canonical_url: "https://data.cityofnewyork.us/d/hn5i-inap", dataset_id: null, asset_type: "calculation", authority: "derived", access_method: "calculation", attribution: "Derived from NYC Parks data", snapshot_hash: null, geometry_type: "edge metrics", pilot_coverage: metadata.edgeCoverage, derived_from: ["nyc-forestry-tree-points", "nyc-parks-properties", "openstreetmap"], method_version: metadata.methodVersion, known_limitations: ["Tree adjacency is not canopy or shade", "Park proximity does not prove an open entrance", "Edges without valid stored geometry receive no favorable greenery evidence"], allowed_claims: ["More mapped tree and park adjacency than baseline"], prohibited_claims: ["Shadier", "Cooler", "Park access guaranteed"] });
